...
import {fetchTracks, getTrackById} from "../../store/slices/trackSlice";
...
const TrackPage: FC<TrackItemProps> = ({serverTrack}) => {
    ...
    return (
        <MainLayout title={'Музыкальная площадка - ' + track.name + " - " + track.artist} keywords={'Музыка, артисты' + track.name + ',' + track.artist}>
            ...
            <Grid container style={{margin: '20px 0'}}>
                <img src={"http://localhost:5000/" + track.picture} width={200} height={200} alt={'#'}/>
                <div style={{margin: 30}}>
